  ...
  return (
    <div className='flex justify-start items-center flex-col h-screen'>
      <div className="relative w-full h-full">
        <video src={shareVideo} type="video/mp4" loop controls={false} 
        muted autoPlay className='w-full h-full object-cover'/>
      </div>
        ...
        items-center top-0 right-0 left-0 bottom-0 bg-blackOverlay'>
          ...
          <div className="shadow-2x1">
            ...
            render={(rederProps)=>(
              ...
              items-center p-3 rounded-lg cursor-pointer outline-none' 
              onClick={rederProps.onClick} disabled={rederProps.disabled}>
